...
class Alien(Sprite): 
    ...
    aelist1 = [20, 20, 'blank']
    aelist2 = [30, 30, 'blank']
    alien_explosion_images = [[pg.transform.rotozoom(pg.image.load(f'spaceInvaders_start/images/explosion_{el}.png'), 0, 1.5) for el in aelist2],
                              [pg.transform.rotozoom(pg.image.load(f'spaceInvaders_start/images/explosion_{el}.png'), 0, 1.5) for el in aelist1] ,
                              [pg.transform.rotozoom(pg.image.load(f'spaceInvaders_start/images/explosion_{el}.png'), 0, 1.5) for el in aelist0]]
